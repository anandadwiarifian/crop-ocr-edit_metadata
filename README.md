# Photo Processor: Crop, OCR, and Edit Metadata

A simple set of scripts to process my kid's preschool check-in/check-out photos by:
1. Cropping the images by defining the position and the crop size
